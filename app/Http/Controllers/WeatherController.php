...
class WeatherController extends Controller
{
    ...
    public function getInfo($img)
    {
        ...
        if ($imgNum == 101 || $imgNum == 110 || $imgNum == 210 || $imgNum == 201) {
            $info = 'sunnyCloudy';
        } elseif ($imgNum == 102 || $imgNum == 112 || $imgNum == 301 || $imgNum == 311) {
            $info = 'sunnyRainy';
        } elseif ($imgNum == 202 || $imgNum == 212 || $imgNum == 302 || $imgNum == 313) {
            $info = 'cloudyRainy';
        } elseif ($imgNum == 308 || $imgNum == 406) {
            $info = 'storm';
        } elseif ($imgNum < 200) {
            $info = 'sunny';
        } elseif ($imgNum < 300) {
